...
def update_tau(pi_0, cost, pdf0_, pdf1_):
    ...
    global tau_prime; tau_prime  = inverse_likelihood(pdf0, pdf1, tau)
...
pi_slider_ax     = fig.add_axes([0.25, 0.1, 0.45, 0.03], facecolor=axis_color)
pi_slider        = Slider(pi_slider_ax, r'$\pi_0$', 0.01, 0.99, valinit=pi_0)


R0_text = fig.text(0.8, 0.85, r'$R_0(\delta)$ = ',   color='black', fontsize=10, visible=True)
R1_text = fig.text(0.8, 0.80, r'$R_1(\delta)$ = ',   color='black', fontsize=10, visible=True)
rb_text = fig.text(0.8, 0.75, r'$r_b(\delta)$   = ', color='black', fontsize=10, visible=True)
