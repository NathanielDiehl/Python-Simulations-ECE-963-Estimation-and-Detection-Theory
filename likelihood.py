...
[likelihood_line]     = ax[1].plot(tau_t, likelihood(pdf0, pdf1, tau_t), linewidth=2, color='red', alpha=0.5)
[pi_0_point]          = ax[1].plot(tau_prime, likelihood(pdf0, pdf1, tau_prime), 'o')
...
def draw_plots():   
    ...
    global tau_prime
    likelihood_line.set_ydata(likelihood(pdf0, pdf1, tau_t))
    pi_0_point.set_xdata([tau_prime])
    pi_0_point.set_ydata(likelihood(pdf0, pdf1, tau_prime))
